    ...
    export default {
        ...
        methods: {
            ...
            onLogInFacebookClick (event: any) {
                ...
                this.$store.dispatch('showActionDialog', { heading: 'Przepraszamy', message: 'Logowanie przez facebook chwilowo niemożliwe. Weryfikacja aplikacji przez facebook została wstrzymana przez koronawirusa.<br><br>Więcej informacji: <a target="_blank" href="https://developers.facebook.com/blog/post/2020/03/24/pausing-individual-verification/">https://developers.facebook.com/blog/post/2020/03/24/pausing-individual-verification/</a>', okText: 'OK' });
